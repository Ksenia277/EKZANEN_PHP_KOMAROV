...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 28 2024 г., 15:17
...
(1, 'user', 'user@mail.com', '5cc32e366c87c4cb49e4309b75f57d64');
...
--
ALTER TABLE `violations`
  ADD CONSTRAINT `violations_ibfk_1` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`);
COMMIT;
